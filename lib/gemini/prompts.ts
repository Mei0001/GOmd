...
### 3. 画像の処理
- ![代替テキスト](画像パス)形式で出力してください
- 図番号やキャプションがあれば代替テキストに含めてください
- 画像の前後に適切な改行を挿入してください

例:
![図1: 関数のグラフ](image1.png)
...
あなたは数学文書の専門家です。以下のPDFを、数式を重点的に正確に変換してMarkdown形式で出力してください。
